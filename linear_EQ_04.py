...
def error_sys_T(error_message):
    """print the colour and font for the error message and desplyes it agian and agian"""

    Error_re_send_message = []
    Error_re_send_message.append(error_message)

    if error_message == "re":
        Error_re_send_message.remove("re")
    else:
        Error_re_send_message.remove(error_message)
        Error_re_send_message.append(error_message)
    ...
    while True:
        ...
        try:
            ...
            if response < 1: 
                ...
                error_sys_T("Please enter an integer that is 1 or more")
...
def int_check(question, low=None, high=None, exit_code=None,):
    ...
    while True: 
        ...
        try:
            ...
            error_sys_T("Please enter in a number")
...
def yes_no(Qustion):
    ...
    while True:
        ...
        if responce == "yes" or responce == "y":
            ...
            error_sys_T("please enter yes or no")
...
# Check that users have entered a valid
# option based on a list
def string_checker(Question, valid_ans=( sys_H_password,'all', 'a','hard','h','medium','m','easy','e','')):
    ...
    while True:
        ...
        error_sys_T("Please enter Hard, Medium, Easy, or Enter for All (Enter)")
...
MEHM_moded = string_checker(f" [?] Would you like your test Hard, Medium, Easy, or All (Enter)? ")
...
Answer_showing_after_question = yes_no(f" [?] Would you like to see your answers as you are doing your quiz? ")
...
num_rounds = In_Re_modes(f"{BOLD} [?] How many questions would you like? Push <enter> for infinite mode? {END}")
...
# changing the signs for the explaning of the answer
   ...
   if question == "Q1" or question == "Q2" or question == "Q3":
        ...
        # Calculation logic for multi-step addition and subtraction
        if AMP == "/" and AMP_02 ==  "x" or AMP == "x" and AMP_02 == "/":
            equation = f"({Num_03}{sign_01}{Num_01}){sign_02}{Num_02}"
